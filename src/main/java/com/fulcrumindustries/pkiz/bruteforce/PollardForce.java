...
public class PollardForce {
     ...
     *
     * Esse algoritmo é uma heurística, onde que uma de suas vantagems é o uso
     * constante de recursos para buscar da solução do problema. O algoritmo de
     * Pollards-rho nunca imprime um divisor não trivial (ou seja, d != 1 e d !=
     * n).
     */
